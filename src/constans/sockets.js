export const SOCKET_CONNECTION_REQUEST = Symbol(
  "sockets/SOCKET_CONNECTION_REQUEST"
);
export const SOCKET_CONNECTION_SUCCESS = Symbol(
  "sockets/SOCKET_CONNECTION_SUCCESS"
);
export const SOCKET_CONNECTION_FAILURE = Symbol(
  "sockets/SOCKET_CONNECTION_FAILURE"
);
export const SOCKET_CONNECTION_MISSING = Symbol(
  "sockets/SOCKET_CONNECTION_MISSING"
);
